...
class WOFPlayer():
    ...
    def addMoney(self, amt):
        self.prizeMoney = self.prizeMoney + int(amt)
...
class WOFComputerPlayer(WOFPlayer):
    ...
    def getMove(self, category, obscuredPhrase, guessed):
        ...
        get_l = self.getPossibleLetters(guessed)
        flip_coin = self.smartCoinFlip()
